...
int main() {
    ...
    printRectanglePerimeter(calculateRectanglePerimeter(heightInInches, widthInInches), heightInInches, widthInInches);
    printRectangleArea(calculateRectangleArea(heightInInches, widthInInches), heightInInches, widthInInches);
